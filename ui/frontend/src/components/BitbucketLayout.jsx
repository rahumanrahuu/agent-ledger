...
export default function BitbucketLayout({ children }) {
          ...
          <div className="bb-sidebar-content">
            <div className="bb-sidebar-section">
              ...
              <nav className="bb-sidebar-nav">
                <a
                  href="#overview"
                  className={`bb-nav-item ${activeNav === 'overview' ? 'active' : ''}`}
                ...
                <a
                  href="#memories"
                  className={`bb-nav-item ${activeNav === 'memories' ? 'active' : ''}`}
                ...
                <a
                  href="#traces"
                  className={`bb-nav-item ${activeNav === 'traces' ? 'active' : ''}`}
                ...
                <a
                  href="#agents"
                  className={`bb-nav-item ${activeNav === 'agents' ? 'active' : ''}`}
                ...
                <a
                  href="#collaboration"
                  className={`bb-nav-item ${activeNav === 'collaboration' ? 'active' : ''}`}
            ...
            <div className="bb-sidebar-section">
              ...
              <nav className="bb-sidebar-nav">
                <a href="#search" className="bb-nav-item">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                ...
                <a href="#constraints" className="bb-nav-item">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                ...
                <a href="#settings" className="bb-nav-item">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
